...
public class StoreReview implements Serializable {
	...
	private final static long serialVersionUID = -5515783553942200862L;
	 ...
	 * @param comment
	 */
	public StoreReview(String image, String name, String comment, Integer rating, List<String> images) {
		super();
		this.image = image;
		this.name = name;
